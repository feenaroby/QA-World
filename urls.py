...
urlpatterns = [
    ...
    path('chatexp/<int:id>', views.exp_chat,name="chatexp"),
    ...
    path('users_payment/', views.users_payment),
    path('payment_done1/<int:id>', views.payment_done1),
    path('Expert_payment/', views.Expert_payment),
